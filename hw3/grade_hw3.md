...
- Q1 (30/40)
    ...
    Final tibble should be about 53,065 rows and about 44 columns. The final icu_cohort.rds should be about 24.6MB. Some students didn't collect results into memory and essentially save the SQL query; take 10 points off in this case. It seems to query each time `-10`.

- Q2 (40/40) Shiny app

    Your app worked well once we got the data to laod in each time which took forever because of the way you saved your rds file.
